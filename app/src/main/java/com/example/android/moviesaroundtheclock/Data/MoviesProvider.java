...
public class MoviesProvider extends ContentProvider {
    ...
    private static final int MOVIE_POPULAR_WITH_ID = 300;
    private static final int MOVIE_HIGHEST_RATED_WITH_ID = 301;

    public static long getMovieKeyFromUri(Context context, long id){
        Cursor cursor;
